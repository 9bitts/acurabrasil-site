...
function buildEmailContent({ nome, email, assuntoLabel, mensagem, phone }) {
  return {
...
async function sendViaResend({ nome, email, assuntoLabel, mensagem, phone }) {
  const { subject, text } = buildEmailContent({ nome, email, assuntoLabel, mensagem, phone });
...
async function sendViaSmtp({ nome, email, assuntoLabel, mensagem, phone }) {
