...
const { normalizeWhatsAppDigits, DOCTOR8_WABA_WHATSAPP_E164 } = require('./whatsapp-contact');
const {
...
function getWhatsappNumber() {
  try {
    ...
    return normalizeWhatsAppDigits(row?.whatsapp_number || DOCTOR8_WABA_WHATSAPP_E164);
  } catch {
    return DOCTOR8_WABA_WHATSAPP_E164;
  }
}
