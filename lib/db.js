...
function seedHubsIfEmpty(db) {
  ...
  const insert = db.prepare(`
    INSERT INTO sos_hubs (slug, nome, url_site, categoria, status, ordem, updated_at)
    VALUES (@slug, @nome, @url_site, @categoria, 'pendente', @ordem, datetime('now'))
  `);

  const hubs = [
    { slug: 'venezuela-ayuda', nome: 'Venezuela Ayuda', url_site: 'https://venezuela-ayuda.org', categoria: 'Directorio humanitario', ordem: 1 },
    { slug: 'reconstruyamos', nome: 'Reconstruyamos Venezuela', url_site: 'https://reconstruyamosvenezuela.org', categoria: 'Reconstrucción / ayuda', ordem: 2 },
    { slug: 'info-central', nome: 'Info Central Terremoto Venezuela', url_site: 'https://info-central-terremoto-venezuela.com', categoria: 'Info terremoto', ordem: 3 },
    { slug: 'ayudaavenezuela', nome: 'Ayuda a Venezuela', url_site: 'https://ayudaavenezuela.org', categoria: 'Ayuda humanitaria', ordem: 4 },
  ];
