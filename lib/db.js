...
const DEFAULT_OUT_OF_HOURS_ES =
  'Gracias por contactar SOS Venezuela — ACURA Brasil. Nuestro equipo de voluntarios atiende de lunes a domingo, 9:00–12:00 y 14:00–18:00 (hora de Brasilia). Si ya completó el formulario, guarde su número de protocolo. En emergencia grave: en Venezuela llame al 911 (VEN-911); en Brasil, al 192 (SAMU) o 188 (CVV).';
const DEFAULT_OUT_OF_HOURS_PT =
  'Obrigado por contactar o SOS Venezuela — ACURA Brasil. Nossa equipe de voluntários atende de segunda a domingo, 9:00–12:00 e 14:00–18:00 (horário de Brasília). Se já preencheu o formulário, guarde seu número de protocolo. Em emergência grave: na Venezuela ligue 911 (VEN-911); no Brasil, 192 (SAMU) ou 188 (CVV).';
...
const DEFAULT_LISTING_SUBTITULO =
  'Telemedicina humanitaria de ACURA BRASIL para víctimas de los terremotos';
...
const DEFAULT_LISTING_DESC_LONGA = `SOS Salud Venezuela es un proyecto humanitario de ACURA BRASIL que ofrece consultas médicas y psicológicas en línea, 100% gratuitas, para víctimas de los terremotos de junio de 2026 en Venezuela.
...
Atendemos emergencias emocionales, evaluación de lesiones, orientación sobre medicamentos y derivación cuando sea necesario. Operamos con voluntarios certificados (CFM/CRP) y seguimos el modelo probado del SOS Salud Río Grande do Sul (2.664 consultas gratuitas en 2024).
...
Somos a ACURA BRASIL (Associação Brasil pela Cura), OSCIP certificada, e gostaríamos de apresentar o SOS Salud Venezuela — projeto de telemedicina humanitária 100% gratuita para vítimas dos terremotos de junio de 2026 na Venezuela.

Oferecemos consultas médicas e psicológicas en línea, com triagem humanizada e atendimento via plataforma Doctor8, seguindo o modelo do SOS Salud Río Grande do Sul (2.664 consultas gratuitas em 2024).

Link para encaminhamento de pacientes:
{link_solicitud}

Site: https://www.acurabrasil.org/sos-venezuela.html
...
A ACURA BRASIL, associação humanitária sem fins lucrativos, oferece o SOS Salud Venezuela — atendimento médico e psicológico gratuito por telemedicina para venezuelanos afetados pelos terremotos.
...
A ACURA BRASIL convida sua associação a conhecer o SOS Salud Venezuela — consultas médicas y psicológicas gratuitas en línea para connacionales afectados por los terremotos.
...
ACURA BRASIL — Associação Brasil pela Cura`;
...
function seedListingKitIfEmpty(db) {
  ...
  `).run({
    ...
    organizacao: 'ACURA BRASIL (Associação Brasil pela Cura)',
    cnpj: '30.350.850/0001-80',
