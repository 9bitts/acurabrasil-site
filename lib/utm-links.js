...
function buildSetembroAmareloLinks(siteBase, source = 'acurabrasil') {
  ...
  const solicitud = new URL('/setembroamarelo', `${base}/`);
  solicitud.searchParams.set('utm_source', common.source);
  solicitud.searchParams.set('utm_medium', common.medium);
  solicitud.searchParams.set('utm_campaign', common.campaign);
  solicitud.searchParams.set('utm_content', 'hero');
  solicitud.hash = 'pagar';
